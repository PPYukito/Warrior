...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_SucessfulBlock, "Player.Event.SucessfulBlock");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Status_Rage_Have, "Player.Status.Rage.Have");
	...
	UE_DEFINE_GAMEPLAY_TAG(Shared_Event_SpanwProjectile, "Shared.Event.SpanwProjectile");
